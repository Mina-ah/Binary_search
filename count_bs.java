//Binary search where if we have a index we will find the first occurence and last occurence and calculate for the overall count of search key by subtracting first count with the last count and adding 1 to it
...
public class Main
{
	...
	public static void main(String[] args) {
		...
		System.out.println("Count of occurences are: " + count);
	}
}
